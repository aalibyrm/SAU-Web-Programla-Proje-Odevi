        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MesaiBaslangic = table.Column<TimeSpan>(type: "time", nullable: false),
                    MesaiBitis = table.Column<TimeSpan>(type: "time", nullable: false),
                    AktifMi = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AntrenorHizmetleri", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Salonlar",
                columns: new[] { "Id", "AcilisSaati", "Ad", "Adres", "AktifMi", "KapanisSaati", "Telefon" },
                values: new object[] { 1, new TimeSpan(0, 7, 0, 0, 0), "FitLife Spor Merkezi", "Sakarya Üniversitesi Kampüsü, Esentepe", true, new TimeSpan(0, 23, 0, 0, 0), "0264 123 45 67" });

            migrationBuilder.InsertData(
                table: "Antrenorler",
                columns: new[] { "Id", "Ad", "AktifMi", "Eposta", "FotografYolu", "MesaiBaslangic", "MesaiBitis", "SalonId", "Soyad", "Telefon", "UzmanlikAlanlari" },
                values: new object[,]
                {
                    { 1, "Ahmet", true, "ahmet@sporsalonu.com", null, new TimeSpan(0, 9, 0, 0, 0), new TimeSpan(0, 18, 0, 0, 0), 1, "Yılmaz", "0532 111 22 33", "Fitness, Kilo Verme" },
                    { 2, "Zeynep", true, "zeynep@sporsalonu.com", null, new TimeSpan(0, 10, 0, 0, 0), new TimeSpan(0, 19, 0, 0, 0), 1, "Kaya", "0533 222 33 44", "Yoga, Pilates" },
                    { 3, "Murat", true, "murat@sporsalonu.com", null, new TimeSpan(0, 12, 0, 0, 0), new TimeSpan(0, 21, 0, 0, 0), 1, "Demir", "0534 333 44 55", "Kickboks, Fitness" }
                });

            migrationBuilder.InsertData(
                table: "Hizmetler",
                columns: new[] { "Id", "Aciklama", "Ad", "AktifMi", "SalonId", "SureDakika", "Ucret" },
                values: new object[,]
                {
                    { 1, "Kişiye özel fitness antrenmanı", "Fitness", true, 1, 60, 250m },
                    { 2, "Rahatlama ve esneklik için yoga dersi", "Yoga", true, 1, 45, 200m },
                    { 3, "Core kasları güçlendirme", "Pilates", true, 1, 50, 220m },
                    { 4, "Yüksek tempolu dövüş sporu antrenmanı", "Kickboks", true, 1, 60, 280m },
                    { 5, "Özel diyet ve egzersiz kombinasyonu", "Kilo Verme Programı", true, 1, 90, 350m }
                });

            migrationBuilder.InsertData(
                table: "AntrenorHizmetleri",
                columns: new[] { "Id", "AntrenorId", "HizmetId" },
                values: new object[,]
                {
                    { 1, 1, 1 },
                    { 2, 1, 5 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AntrenorHizmetleri_AntrenorId",
                table: "AntrenorHizmetleri",
                column: "AntrenorId");
